                ...
                <div class="col-md-8">
                    <div id="serv_hover" class="room">
                        <div style="padding: 20px;" class="room_img">
                            <figure><img style="height: 300px; width: 820px;" src="/room/{{ $room->gambar }}" alt="#" /></figure>
                        </div>
                        <div class="bed_room">
                    ...
                    <form action="{{ url('booking_kamar', $room->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="email" id="floatingInput"
                                placeholder="bebas@example.com"
                                value="{{ Auth::user()->email }}"">
                        </div>
                        <div class="mb-3">
                            <label for="floatingInput">No Telepon</label>
                            <input type="text" class="form-control" name="telepon" id="floatingInput"
                                placeholder="+62..."
